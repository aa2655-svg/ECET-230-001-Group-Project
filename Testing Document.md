...
## Manual Tests (User-Level Verification) 
These tests can be done by anyone building the system to confirm basic functionality
...
### Automatic Tests (No Manual Input Required)
These tests rely on the automatic demo code to verify system behavior at the user level
#### Steps
...
### Gripper Safety Test
Verify that the gripper never fully crosses or damages itself
#### Steps
...
### Basic Safety and Reliability Tests
Ensure the system can operate for a short continuous period without failure
#### Steps
